...
export function CreateAdModal() {
  ...
  async function handleCreatedAd(event : FormEvent) {
    ...
    alert('Anúnciado criado com sucesso!')
    } catch (err) {
      console.log(err)
        ...
        <form onSubmit={handleCreatedAd} className='mt-8 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <select 
              name="game"
              id="game" 
              className='bg-zinc-900 py-3 px-4 rounded font text-sm placeholder:text-zinc-500'
              defaultValue=""
            >
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='flex flex-col gap-2'>
              ...
              id="yearsPlaying" type="number" placeholder="tudo bem ser ZERO" />
            </div>

            <div className='flex flex-col gap-2'>
              <label htmlFor="discord">Qual seu Discord?</label>
              <Input name ="discord" 
              id="discord" type="text" placeholder="Usuario#0000" />
            </div>
          </div>
          ...
          <div className='flex gap-6'>
            ...
            <div className='flex flex-col gap-2 flex-1'>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                id="hourStart" type="time" placeholder="De" />
                <Input name ="hourEnd" 
                id="hourEnd" type="time" placeholder="Até" />
              </div>
            </div>
          </div>
